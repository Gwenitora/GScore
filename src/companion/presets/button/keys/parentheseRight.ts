...
// ================================================== Steps and Actions ================================================== //
class VirtualKey_RightParentheseAction1_1 extends CompPresetAction {
...
class VirtualKey_RightParentheseStep1 extends CompPresetStep {
    name = 'Add \')\' to preview';
    onClick = [
        new VirtualKey_RightParentheseAction1_1()
    ];
    onRelease = [];
    onRotateLeft = [];
    onRotateRight = [];
...
// ================================================== Preset ================================================== //
class VirtualKey_RightParenthese extends CompPresetButton {
    id = 'virtualRightParenthese';
    ...
    feedBacks = [];
    steps = [
        new VirtualKey_RightParentheseStep1()
    ];
}

export default VirtualKey_RightParenthese;